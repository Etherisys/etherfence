...
Status: **v1.7.0 — production-ready for controlled local-first deployments
...
# etherfence-v1.7.0-linux-x86_64/{etherfence,README.md,LICENSE}.
...
# Extract. The archive contains a versioned directory, e.g.
# etherfence-v1.7.0-windows-x86_64\{etherfence.exe,README.md,LICENSE}.
...
installed (`1.7.0` for this release).
