...
Status: **v1.0.1 — production-ready for controlled local-first deployments
...
# etherfence-v1.0.1-linux-x86_64/{etherfence,README.md,LICENSE}.
...
# Extract. The archive contains a versioned directory, e.g.
# etherfence-v1.0.1-windows-x86_64\{etherfence.exe,README.md,LICENSE}.
...
installed (`1.0.1` for this release).
